...
The blocks in the picture above describe a situation my friends and I get into many times while coding. Of course, we use [version control](https://en.wikipedia.org/wiki/Revision_control) but then not every small change is worth a team commit: a commit with a message that meaningfully represents the change, and the whole effort of making that commit. 
...
You can definitely benefit from LV if you code in any computer language or write text documents (like latex files) on regular basis. Most visual git clients like [Source Tree](https://www.sourcetreeapp.com) let you see the differences between each commit. 
...
[situation]: {{ site.baseurl }}/images/lv-situation.png
[features]: {{ site.baseurl }}/images/lv-features.png
[overview]: {{ site.baseurl }}/images/lv-overview.png
[day1]: {{ site.baseurl }}/images/lv-day1.png
[day2]: {{ site.baseurl }}/images/lv-day2.png
[day3-prep]: {{ site.baseurl }}/images/lv-day3-prep.png
[day3]: {{ site.baseurl }}/images/lv-day3.png
[day4]: {{ site.baseurl }}/images/lv-day4.png
